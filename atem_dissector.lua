...
VALS["VALS_TRANSFER_TYPE"] = {[0] = "Still", [1] = "Clip", [2] = "Sound", [3] = "MV labels", [255] = "Macro"}

pf_fields["pf_field_filename"]  = ProtoField.new  ("File Name", "atem.field.filename", ftypes.STRING, nil, base.NONE)
pf_fields["pf_cmd_mpcs_unknown6"]   = ProtoField.new  ("Unknown", "atem.cmd.mpcs.unknown6", ftypes.NONE, nil, base.NONE)
pf_fields["pf_field_frames"]    = ProtoField.new  ("Frames", "atem.field.frames", ftypes.UINT16, nil, base.DEC)
pf_fields["pf_cmd_mpas_unknown7"]   = ProtoField.new  ("Unknown", "atem.cmd.mpas.unknown7", ftypes.NONE, nil, base.NONE)
pf_fields["pf_cmd_mpas_unknown8"]   = ProtoField.new  ("Unknown", "atem.cmd.mpas.unknown8", ftypes.NONE, nil, base.NONE)
pf_fields["pf_cmd_mpfe_type"]    = ProtoField.new  ("Type", "atem.cmd.mpfe.type", ftypes.UINT8, VALS["VALS_TRANSFER_TYPE"], base.DEC)
pf_fields["pf_cmd_mpfe_stillbank"]  = ProtoField.new  ("Still Bank", "atem.cmd.mpfe.stillbank", ftypes.UINT8, nil, base.DEC)
...
pf_fields["pf_cmd_cssc_setmask22"]  = ProtoField.new  ("Set Mask", "atem.cmd.cssc.setmask22", ftypes.UINT32, nil, base.DEC, 0xFFFFFFFF)
...
pf_fields["pf_flag_cmd_cssc_setmask22_enabled"] = ProtoField.new ("Enabled", "atem.cmd.cssc.setmask22.flags.enabled", ftypes.BOOLEAN, {"On","Off"}, 20, 0x80)
pf_fields["pf_flag_cmd_cssc_setmask22_bevel"] = ProtoField.new ("Bevel", "atem.cmd.cssc.setmask22.flags.bevel", ftypes.BOOLEAN, {"On","Off"}, 20, 0x100)
pf_fields["pf_flag_cmd_cssc_setmask22_outerwidth"] = ProtoField.new ("Outer Width", "atem.cmd.cssc.setmask22.flags.outerwidth", ftypes.BOOLEAN, {"On","Off"}, 20, 0x200)
pf_fields["pf_flag_cmd_cssc_setmask22_innerwidth"] = ProtoField.new ("Inner Width", "atem.cmd.cssc.setmask22.flags.innerwidth", ftypes.BOOLEAN, {"On","Off"}, 20, 0x400)
pf_fields["pf_flag_cmd_cssc_setmask22_outersoftness"] = ProtoField.new ("Outer Softness", "atem.cmd.cssc.setmask22.flags.outersoftness", ftypes.BOOLEAN, {"On","Off"}, 20, 0x800)
pf_fields["pf_flag_cmd_cssc_setmask22_innersoftness"] = ProtoField.new ("Inner Softness", "atem.cmd.cssc.setmask22.flags.innersoftness", ftypes.BOOLEAN, {"On","Off"}, 20, 0x1000)
pf_fields["pf_flag_cmd_cssc_setmask22_bevelsoftness"] = ProtoField.new ("Bevel Softness", "atem.cmd.cssc.setmask22.flags.bevelsoftness", ftypes.BOOLEAN, {"On","Off"}, 20, 0x2000)
pf_fields["pf_flag_cmd_cssc_setmask22_bevelpos"] = ProtoField.new ("Bevel Pos", "atem.cmd.cssc.setmask22.flags.bevelpos", ftypes.BOOLEAN, {"On","Off"}, 20, 0x4000)
pf_fields["pf_flag_cmd_cssc_setmask22_hue"] = ProtoField.new ("Hue", "atem.cmd.cssc.setmask22.flags.hue", ftypes.BOOLEAN, {"On","Off"}, 20, 0x8000)
pf_fields["pf_flag_cmd_cssc_setmask22_saturation"] = ProtoField.new ("Saturation", "atem.cmd.cssc.setmask22.flags.saturation", ftypes.BOOLEAN, {"On","Off"}, 20, 0x10000)
pf_fields["pf_flag_cmd_cssc_setmask22_luma"] = ProtoField.new ("Luma", "atem.cmd.cssc.setmask22.flags.luma", ftypes.BOOLEAN, {"On","Off"}, 20, 0x20000)
...
pf_fields["pf_cmd_lokb_storeId"]    = ProtoField.new  ("Store ID", "atem.cmd.lokb.storeId", ftypes.UINT8, VALS["VALS_TRANSFER_TYPE"], base.DEC)
pf_fields["pf_cmd_lock_storeId"]    = ProtoField.new  ("Store ID", "atem.cmd.lock.storeId", ftypes.UINT8, VALS["VALS_TRANSFER_TYPE"], base.DEC)
...
pf_fields["pf_cmd_lkst_mediaId"]    = ProtoField.new  ("Media ID", "atem.cmd.lkst.mediaId", ftypes.UINT8, nil, base.DEC)
...
pf_fields["pf_cmd_ftsd_storeId"]    = ProtoField.new  ("Transfer Store ID", "atem.cmd.ftsd.storeId", ftypes.UINT8, VALS["VALS_TRANSFER_TYPE"], base.DEC)
...
pf_fields["pf_cmd_ftsd_op"]         = ProtoField.new  ("Operation", "atem.cmd.ftsd.op", ftypes.UINT8, VALS["VALS_FTSD_OP"], base.DEC)
...
pf_fields["pf_cmd_ftfd_filename"]   = ProtoField.new  ("Transfer ID", "atem.cmd.ftfd.filename", ftypes.STRING, nil, base.NONE)
pf_fields["pf_cmd_ftfd_hash"]       = ProtoField.new  ("Transfer ID", "atem.cmd.ftfd.hash", ftypes.BYTES)
...
function atem_proto.dissector(tvbuf,pktinfo,root)
	...
	while (pktlen_remaining > 0) do
		...
		elseif (cmd_name == "MPCS") then
			...
			cmd_tree:add(pf_fields["pf_field_filename"], tvbuf:range(pos+10, 16))
			cmd_tree:add(pf_fields["pf_cmd_mpcs_unknown6"], tvbuf:range(pos+26, 48))
			cmd_tree:add(pf_fields["pf_field_frames"], tvbuf:range(pos+74, 2))
		elseif (cmd_name == "MPAS") then
			cmd_tree:add(pf_fields["pf_field_clipbank"], tvbuf:range(pos+8, 1))
			cmd_tree:add(pf_fields["pf_field_isused"], tvbuf:range(pos+9, 1))
			cmd_tree:add(pf_fields["pf_cmd_mpas_unknown7"], tvbuf:range(pos+10, 16))
			cmd_tree:add(pf_fields["pf_field_filename"], tvbuf:range(pos+26, 16))
			cmd_tree:add(pf_fields["pf_cmd_mpas_unknown8"], tvbuf:range(pos+42, 50))
		elseif (cmd_name == "MPfe") then
			cmd_tree:add(pf_fields["pf_cmd_mpfe_type"], tvbuf:range(pos+8, 1))
			cmd_tree:add(pf_fields["pf_field_unknown1"], tvbuf:range(pos+9, 1))
			cmd_tree:add(pf_fields["pf_cmd_mpfe_stillbank"], tvbuf:range(pos+11, 1))
		...
		elseif (cmd_name == "SSrc") then
			cmd_tree:add(pf_fields["pf_field_fillsource"], tvbuf:range(pos+8, 2))
			cmd_tree:add(pf_fields["pf_field_keysource"], tvbuf:range(pos+10, 2))
			cmd_tree:add(pf_fields["pf_field_foreground"], tvbuf:range(pos+12, 1))
			cmd_tree:add(pf_fields["pf_field_premultiplied"], tvbuf:range(pos+13, 1))
			cmd_tree:add(pf_fields["pf_field_clip"], tvbuf:range(pos+14, 2))
			cmd_tree:add(pf_fields["pf_field_gain0"], tvbuf:range(pos+16, 2))
			cmd_tree:add(pf_fields["pf_field_invertkey0"], tvbuf:range(pos+18, 1))
			cmd_tree:add(pf_fields["pf_field_borderenabled"], tvbuf:range(pos+19, 1))
			cmd_tree:add(pf_fields["pf_field_borderbevel"], tvbuf:range(pos+20, 1))
			cmd_tree:add(pf_fields["pf_field_unknown1"], tvbuf:range(pos+21, 1))
			cmd_tree:add(pf_fields["pf_field_borderouterwidth"], tvbuf:range(pos+22, 2))
			cmd_tree:add(pf_fields["pf_field_borderinnerwidth"], tvbuf:range(pos+24, 2))
			cmd_tree:add(pf_fields["pf_field_borderoutersoftness"], tvbuf:range(pos+26, 1))
			cmd_tree:add(pf_fields["pf_field_borderinnersoftness"], tvbuf:range(pos+27, 1))
			cmd_tree:add(pf_fields["pf_field_borderbevelsoftness"], tvbuf:range(pos+28, 1))
			cmd_tree:add(pf_fields["pf_field_borderbevelposition"], tvbuf:range(pos+29, 1))
			cmd_tree:add(pf_fields["pf_field_borderhue"], tvbuf:range(pos+30, 2))
			cmd_tree:add(pf_fields["pf_field_bordersaturation"], tvbuf:range(pos+32, 2))
			cmd_tree:add(pf_fields["pf_field_borderluma"], tvbuf:range(pos+34, 2))
			cmd_tree:add(pf_fields["pf_field_lightsourcedirection"], tvbuf:range(pos+36, 2))
			cmd_tree:add(pf_fields["pf_field_lightsourcealtitude"], tvbuf:range(pos+38, 1))
			cmd_tree:add(pf_fields["pf_field_unknown1"], tvbuf:range(pos+39, 1))
		elseif (cmd_name == "CSSc") then
			local cmd_cssc_setmask22_tree = cmd_tree:add(pf_fields["pf_cmd_cssc_setmask22"], tvbuf:range(pos+8, 4))
			cmd_cssc_setmask22_tree:add(pf_fields["pf_flag_cmd_cssc_setmask22_fillsource"], tvbuf:range(pos+8, 4))
			...
			cmd_cssc_setmask22_tree:add(pf_fields["pf_flag_cmd_cssc_setmask22_clip"], tvbuf:range(pos+8, 4))
			...
			cmd_cssc_setmask22_tree:add(pf_fields["pf_flag_cmd_cssc_setmask22_enabled"], tvbuf:range(pos+8, 4))
			cmd_cssc_setmask22_tree:add(pf_fields["pf_flag_cmd_cssc_setmask22_bevel"], tvbuf:range(pos+8, 4))
			cmd_cssc_setmask22_tree:add(pf_fields["pf_flag_cmd_cssc_setmask22_outerwidth"], tvbuf:range(pos+8, 4))
			cmd_cssc_setmask22_tree:add(pf_fields["pf_flag_cmd_cssc_setmask22_innerwidth"], tvbuf:range(pos+8, 4))
			cmd_cssc_setmask22_tree:add(pf_fields["pf_flag_cmd_cssc_setmask22_outersoftness"], tvbuf:range(pos+8, 4))
			cmd_cssc_setmask22_tree:add(pf_fields["pf_flag_cmd_cssc_setmask22_innersoftness"], tvbuf:range(pos+8, 4))
			cmd_cssc_setmask22_tree:add(pf_fields["pf_flag_cmd_cssc_setmask22_bevelsoftness"], tvbuf:range(pos+8, 4))
			cmd_cssc_setmask22_tree:add(pf_fields["pf_flag_cmd_cssc_setmask22_bevelpos"], tvbuf:range(pos+8, 4))
			cmd_cssc_setmask22_tree:add(pf_fields["pf_flag_cmd_cssc_setmask22_hue"], tvbuf:range(pos+8, 4))
			cmd_cssc_setmask22_tree:add(pf_fields["pf_flag_cmd_cssc_setmask22_saturation"], tvbuf:range(pos+8, 4))
			...
			cmd_tree:add(pf_fields["pf_field_fillsource"], tvbuf:range(pos+12, 2))
			cmd_tree:add(pf_fields["pf_field_keysource"], tvbuf:range(pos+14, 2))
			cmd_tree:add(pf_fields["pf_field_foreground"], tvbuf:range(pos+16, 1))
			cmd_tree:add(pf_fields["pf_field_premultiplied"], tvbuf:range(pos+17, 1))
			cmd_tree:add(pf_fields["pf_field_clip"], tvbuf:range(pos+18, 2))
			cmd_tree:add(pf_fields["pf_field_gain0"], tvbuf:range(pos+20, 2))
			cmd_tree:add(pf_fields["pf_field_invertkey0"], tvbuf:range(pos+22, 1))
			cmd_tree:add(pf_fields["pf_field_borderenabled"], tvbuf:range(pos+23, 1))
			cmd_tree:add(pf_fields["pf_field_borderbevel"], tvbuf:range(pos+24, 1))
			cmd_tree:add(pf_fields["pf_field_unknown1"], tvbuf:range(pos+25, 1))
			cmd_tree:add(pf_fields["pf_field_borderouterwidth"], tvbuf:range(pos+26, 2))
			cmd_tree:add(pf_fields["pf_field_borderinnerwidth"], tvbuf:range(pos+28, 2))
			cmd_tree:add(pf_fields["pf_field_borderoutersoftness"], tvbuf:range(pos+30, 1))
			cmd_tree:add(pf_fields["pf_field_borderinnersoftness"], tvbuf:range(pos+31, 1))
			cmd_tree:add(pf_fields["pf_field_borderbevelsoftness"], tvbuf:range(pos+32, 1))
			cmd_tree:add(pf_fields["pf_field_borderbevelposition"], tvbuf:range(pos+33, 1))
			cmd_tree:add(pf_fields["pf_field_borderhue"], tvbuf:range(pos+34, 2))
			cmd_tree:add(pf_fields["pf_field_bordersaturation"], tvbuf:range(pos+36, 2))
			cmd_tree:add(pf_fields["pf_field_borderluma"], tvbuf:range(pos+38, 2))
			cmd_tree:add(pf_fields["pf_field_lightsourcedirection"], tvbuf:range(pos+40, 2))
			cmd_tree:add(pf_fields["pf_field_lightsourcealtitude"], tvbuf:range(pos+42, 1))
			cmd_tree:add(pf_fields["pf_field_unknown1"], tvbuf:range(pos+43, 1))
		elseif (cmd_name == "SSBP") then
			cmd_tree:add(pf_fields["pf_field_box"], tvbuf:range(pos+8, 1))
			cmd_tree:add(pf_fields["pf_field_enabled"], tvbuf:range(pos+9, 1))
			cmd_tree:add(pf_fields["pf_field_inputsource0"], tvbuf:range(pos+10, 2))
			cmd_tree:add(pf_fields["pf_field_positionx2"], tvbuf:range(pos+12, 2))
			cmd_tree:add(pf_fields["pf_field_positiony2"], tvbuf:range(pos+14, 2))
			cmd_tree:add(pf_fields["pf_field_size"], tvbuf:range(pos+16, 2))
			cmd_tree:add(pf_fields["pf_field_cropped"], tvbuf:range(pos+18, 1))
			cmd_tree:add(pf_fields["pf_field_unknown1"], tvbuf:range(pos+19, 1))
			cmd_tree:add(pf_fields["pf_field_croptop"], tvbuf:range(pos+20, 2))
			cmd_tree:add(pf_fields["pf_field_cropbottom"], tvbuf:range(pos+22, 2))
			cmd_tree:add(pf_fields["pf_field_cropleft"], tvbuf:range(pos+24, 2))
			cmd_tree:add(pf_fields["pf_field_cropright"], tvbuf:range(pos+26, 2))
		elseif (cmd_name == "CSBP") then
			...
			cmd_tree:add(pf_fields["pf_field_box"], tvbuf:range(pos+10, 1))
			cmd_tree:add(pf_fields["pf_field_enabled"], tvbuf:range(pos+11, 1))
			...
			cmd_tree:add(pf_fields["pf_field_unknown1"], tvbuf:range(pos+30, 1))
		...
		elseif (cmd_name == "LOCK") then
			cmd_tree:add(pf_fields["pf_cmd_lock_storeId"], tvbuf:range(pos+8, 1))
			cmd_tree:add(pf_fields["pf_cmd_lock_state"], tvbuf:range(pos+9, 1))
		elseif (cmd_name == "LKST") then
			cmd_tree:add(pf_fields["pf_cmd_lkst_mediaId"], tvbuf:range(pos+9, 1))
