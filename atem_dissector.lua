...
pf_fields["pf_cmd_mpfe_hashofstill"]    = ProtoField.new  ("(Hash of still)", "atem.cmd.mpfe.hashofstill", ftypes.STRING, nil, base.NONE)
...
pf_fields["pf_cmd_lokb_storeId"]    = ProtoField.new  ("Store ID", "atem.cmd.lokb.storeId", ftypes.UINT8, nil, base.DEC)
pf_fields["pf_cmd_lock_storeId"]    = ProtoField.new  ("Store ID", "atem.cmd.lock.storeId", ftypes.UINT8, nil, base.DEC)
